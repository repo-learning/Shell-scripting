...
#   
# github token: On your GitHub, Go To - Settings - Developer Settings - Personal access tokens 
################################
# Checking if min 2 arguments are passed or not
if [ ${#@} -lt 2 ]; then
...
temp=`basename $0`
#Store the return value in a temp file, just in case if the value is too big its very difficult to read from terminal
